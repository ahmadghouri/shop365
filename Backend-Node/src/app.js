...
app.use(
  "/api",
  require("./modules/monthly-grocery-cards/monthly-grocery-card.routes"),
);
...
app.use(
  "/api",
  require("./modules/internship-applications/internship-application.routes"),
);
app.use("/api", require("./modules/upload/upload.routes"));
app.use("/api", require("./modules/settings/settings.routes"));
