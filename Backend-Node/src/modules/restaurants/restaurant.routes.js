...
router.post("/orders/:id/assign-rider", orderCtrl.assignRider);
router.post("/riders", riderCtrl.createRider);
router.get("/riders", riderCtrl.listRiders);
router.get("/riders/:id", riderCtrl.getRider);
router.delete("/riders/:id", riderCtrl.deleteRider);
...
router.post(
  ...
  productCtrl.applyDiscountToProduct,
);
