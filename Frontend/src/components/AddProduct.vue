<template>
  <div class="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto">
    <div class="flex min-h-full items-center justify-center p-4">
      <div
        class="max-w-2xl w-full bg-white rounded-xl shadow-xl my-8 max-h-[90vh] flex flex-col"
      >
        <div class="p-6 overflow-y-auto">
          ...
          >
            ...
            <div>
              <label for="restaurant" class="text-sm font-medium text-gray-700"
                >Restaurant</label
              >
              <select
