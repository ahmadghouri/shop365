  ...
  <div class="relative">
    <div class="bg-yellow-500 overflow-hidden">
      <div class="animate-marquee whitespace-nowrap py-2">
        <span class="text-white font-semibold mx-8">🚀 Welcome to Shop365! Our app is in testing phase. You'll be able
          to
    ...
    <transition name="slide-left">
      <div v-if="sidebarOpen" ref="sidebarRef" class="fixed inset-0 bg-black/50 z-40 flex lg:hidden"
        @click="closeSidebar">
