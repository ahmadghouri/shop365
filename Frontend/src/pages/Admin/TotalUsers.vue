<template>
  <div class="bg-gray-50 min-h-screen p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="(user, index) in sortedUsers" :key="user.id" :class="[
        ...
        <div class="p-4 flex-grow">
          <div class="flex justify-between items-start mb-4">
            ...
            <div class="text-sm font-medium px-3 py-1 rounded-full" :class="isTopThree(index)
          ...
          <button @click="showDeleteConfirmation(user.id)"
