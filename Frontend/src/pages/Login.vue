    ...
    <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-lg">
      ...
      <form @submit.prevent="handleLogin" class="space-y-6">
        ...
        <p class="text-sm font-light text-gray-500 text-center mt-4">
          <router-link to="/forgotpassword" class="font-medium text-yellow-600 hover:underline">
            Forgot Password?
          </router-link>
        </p>
        ...
        <p class="text-sm font-light text-gray-500 text-center">
          ...
          <router-link to="/register" class="font-medium text-yellow-600 hover:underline">
            Register
          </router-link>
        </p>
