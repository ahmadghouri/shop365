  ...
  <div class="mobile-spacing lg:px-32" v-if="orderDetails.length > 0">
    <div class="relative mt-2">
      ...
      <div class="flex justify-between items-center">
        ...
        <button @click="refreshOrders" class="bg-yellow-500 text-white px-4 py-2 rounded">
          Refresh
        </button>
      </div>
    </div>
    ...
    <!-- Orders List -->
    <div v-for="order in orderDetails" :key="order.id" class="max-w-full mt-6 bg-gray-200 rounded-lg p-4">
