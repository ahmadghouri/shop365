...
export function MonthlyGroceryListCard({ card, onOpen, onDelete, onOrder }: MonthlyGroceryListCardProps) {
    ...
    return (
        <View className="rounded-[28px] bg-white p-4 shadow-sm shadow-slate-200">
