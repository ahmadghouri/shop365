        ...
        <AppBackground>
            <SafeAreaView className="flex-1" edges={['top', 'left', 'right']}>
                ...
                <View className="flex-row items-center px-5 pb-2 pt-2">
                    {onBack && (
                        <Pressable
                            className="h-11 w-11 items-center justify-center rounded-2xl bg-white/60 active:opacity-60"
                            onPress={onBack}
                        >
                    ...
                    <View className="mx-5 mt-2 overflow-hidden rounded-[28px] bg-[#1D1D1D] shadow-sm shadow-slate-300">
                        ...
                        <View className="items-center px-6 pb-7 pt-8">
                            ...
                            >
                                <View className="h-28 w-28 items-center justify-center overflow-hidden rounded-full border-4 border-amber-400/70 bg-slate-800">
                                    {avatarUri ? (
                                        ...
                                        <Text className="text-3xl font-lufga-bold text-amber-300">
                                            {initials}
                                        </Text>
                                    )}
                                </View>
                            ...
                            <View className="mt-4 flex-row items-center rounded-full bg-white/10 px-4 py-2">
                                ...
                                <Text
                                    className="ml-2 text-xs font-lufga-medium text-slate-200"
                                    numberOfLines={1}
                                >
                                    {address}
                                </Text>
...
function ActionRow({
    ...
    return (
        <Pressable
            onPress={onPress}
            className={`flex-row items-center px-4 ${card ? 'mb-2 rounded-2xl bg-white py-3 shadow-sm shadow-slate-200' : `py-4 active:bg-slate-50 ${last ? '' : 'border-b border-slate-100'}`}`}
        >
